    ...
    <main className="min-h-screen bg-gradient-to-br from-rose-50 to-pink-100 flex flex-col items-center py-12 px-4">
      <div className="max-w-xl w-full bg-white rounded-xl shadow-xl p-8">
        ...
        <div className="mb-6 p-4 bg-gray-50 rounded-lg">
          <h3 className="text-lg font-semibold mb-3">Choose Storage Mode</h3>
          ...
          <div className="space-y-3">
            <label className="flex items-start space-x-3 cursor-pointer">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">
                  Instant creation, perfect for Farcaster sharing. Content
            ...
            <label className="flex items-start space-x-3 cursor-pointer">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">
                  Use your own Pinata account. You can delete content anytime.
                </div>
              </div>
            </label>
          </div>
          ...
          {storageMode === "private" && (
            <div className="mt-4 p-3 bg-blue-50 rounded border border-blue-200">
              ...
              <input
                ...
                className="w-full px-3 py-2 border rounded focus:outline-blue-400 text-sm"
              />
              {showApiKeyHelp && (
                <div className="mt-2 text-xs text-blue-700 bg-blue-100 p-2 rounded">
                  ...
                  . Create a new key with "pinFileToIPFS" and "unpin"
                  permissions.
                </div>
              )}
            </div>
        ...
        <p className="mt-6 text-sm text-gray-600 text-center">
          {storageMode === "quick"
            ? "Perfect for viral Farcaster sharing! Files stored permanently on IPFS."
            : "Private mode: You maintain full control and can delete content anytime."}
        </p>
