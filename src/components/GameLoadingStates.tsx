...
export default function GameLoadingStates({
  cid,
  onRetry,
}: GameLoadingStatesProps) {
        ...
        <div className="bg-white rounded-2xl shadow-2xl px-10 py-16 max-w-lg text-center">
          <div className="mb-6">
            ...
            <p className="text-lg text-gray-600">
              Your Lub match is being prepared...
            </p>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl px-10 py-16 max-w-lg text-center">
          <div className="mb-6">
            ...
            <p className="text-gray-600 mb-4">
              We&apos;re fetching your game from our secure network. This
      ...
      <main className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-pink-50 to-purple-50">
        <div className="bg-white rounded-2xl shadow-2xl px-10 py-16 max-w-lg text-center">
          <div className="mb-6">
            ...
            <p className="text-gray-600 mb-4">
              Your game is almost ready! Sometimes our network needs a little
              extra time to sync everything perfectly.
            </p>
          </div>

          <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg p-4 mb-6 border border-yellow-200">
            <p className="text-sm text-yellow-800">
              <strong>Good news:</strong> Your game was created successfully!
              We&apos;re just making sure everything loads perfectly for your
              special someone. 💕
            </p>
          </div>
      ...
      <div className="bg-white rounded-2xl shadow-2xl px-10 py-16 max-w-lg text-center">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mb-6">
            Don&apos;t worry! Your game was created successfully, but our
            network is being a bit slow today.
          </p>
        </div>
        ...
        <div className="mt-6 pt-6 border-t border-gray-100">
          <p className="text-xs text-gray-400">
            Time waited: {formatTime(timeElapsed)} • Game ID: {cid.slice(0, 8)}
            ...{cid.slice(-6)}
          </p>
        </div>
      </div>
